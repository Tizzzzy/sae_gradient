...
from gradsae_baseline_after import main
...
prediction_file = "predictions_false.jsonl"
...
if __name__ == "__main__":
    ...
    with open('activations_baseline.json', 'r') as file:
    ...
    predictions, indices = generate_predictions(squad, switch=True, data=data, gradient_bool=False)
